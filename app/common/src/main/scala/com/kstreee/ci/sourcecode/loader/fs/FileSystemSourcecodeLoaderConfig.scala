...
final case class FileSystemSourcecodeLoaderConfig(
  sourcePath: String,
  override val sourcecodeUnloaderConfig: Option[SourcecodeUnloaderConfig] = None
) extends SourcecodeLoaderConfig {
